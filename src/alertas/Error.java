...
public class Error extends javax.swing.JDialog {
    ...
    public Error(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        RSAnimation.setBajar(-300, 250, 1, 2, this);
        setLocationRelativeTo(null);
        RSScaleLabel.setScaleLabel(lblimg, "src/imgAlert/cross2.png");
        lblMsgError.setText(mensajeER);
    ...
    private void initComponents() {
        ...
        lblMsgError.setFont(new java.awt.Font("sansserif", 1, 16)); // NOI18N
        lblMsgError.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(lblMsgError, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
    ...
    private void btnIngresarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIngresarMouseEntered
        btnIngresar.setBackground(new Color(255, 0, 0));
        btnIngresar.setForeground(Color.WHITE);
    }//GEN-LAST:event_btnIngresarMouseEntered

    private void btnIngresarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIngresarMouseExited
        btnIngresar.setBackground(Color.WHITE);
        btnIngresar.setForeground(new Color(255, 0, 0));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Error dialogER = new Error(new javax.swing.JFrame(), true);
                dialogER.addWindowListener(new java.awt.event.WindowAdapter() {
                    @Override
    ...
    public static javax.swing.JLabel lblMsgError;
